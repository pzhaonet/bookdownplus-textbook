...
knitr::include_graphics("images/bookdown+journal.png")
```
# Peom

# Music

```{r imgguitar, fig.cap='Guitar', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+guitar.png")
```
...
knitr::include_graphics("images/bookdown+mail.png")
```

# Calendar

```{r imgcalendar, fig.cap='Calendar', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+calendar.png")
```

# (PART) Academic{-}
# Academic articles

text Fig. \@ref(fig:imgarticle).

```{r imgarticle, fig.cap='Article', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+article.png")
```
...
```{r imgchemistry, fig.cap='Chemistry', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+chem.png")
```
...
```{r imgchinese1, fig.cap='Chinese1', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+articlezh.png")
```

```{r imgchinese2, fig.cap='Chinese2', out.width='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("images/bookdown+articlezh2.png")
```
